...
How the Recommenditos team runs Scrum for this project.
...
- **Backlog** – not yet planned into a sprint.
- **To Do** – planned for the current sprint, not started.
